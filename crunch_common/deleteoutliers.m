...
% indices in A of outlier values. Optional output argument outliers =
%returns
...
% value at a time. In any given iteration, the tested value is either =
%the
...
% 1) "Procedures for Detecting Outlying Observations in Samples," by =
%F.E.
%    Grubbs; Technometrics, 11-1:1--21; Feb., 1969, and=20
...
%
% ex:
% [B,idx,outliers] =3D deleteoutliers([1.1 1.3 0.9 1.2 -6.4 1.2 0.94 4.2 =
%1.3 1.0 6.8 1.3 1.2], 0.05)
%    returns:
%    B =3D 1.1000    1.3000    0.9000    1.2000    1.2000    0.9400    =
%1.3000    1.0000    1.3000    1.2000
%    idx =3D  5     8    11
%    outliers =3D -6.4000    4.2000    6.8000
%
% ex:
% B =3D deleteoutliers([1.1 1.3 0.9 1.2 -6.4 1.2 0.94 4.2 1.3 1.0 6.8 =
%1.3 1.2
% Inf 1.2 -Inf 1.1], 0.05, 1)
% returns:
% B =3D 1.1000  1.3000  0.9000  1.2000  NaN  1.2000  0.9400  NaN  1.3000 =
