...
if numchans > 6; numchans = 6; GetEEGData('limitchannels', 6); end
if numchans == 5; numchans = 4; GetEEGData('limitchannels', 4); end
...
%    end
    ...
    [data, gap] = GetEEGData('getnext');    % gap is gap between sessions, if moving between sessions, and it there is a gap
