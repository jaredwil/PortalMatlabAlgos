...
colorNoDay   = [0.75  0.75  0.75]; % Background color of the cells that are not days of the selected month
colorDayB    = [0.90  0.90  0.90]; % Background color of the cells that are day of the selected month
...
colorSelDayB = [0.00  0.70  0.70]; % Background color of the selected day
colorSelDayF = [1.00  1.00  0.80]; % Foreground color of the selected day
...
handles.PuMonth = uicontrol( ...
  ...
  'Units', 'pixels', ...
  'fontsize', 12, ...
  'Position', [ctrlYW+2 figH-ctrlH-3 ctrlMW-2 ctrlH], ...
...
handles.EdYear = uicontrol( ...
  ...
  'Units', 'pixels', ...
  'fontsize', 12, ...
  'Position', [4 figH-ctrlH+4 ctrlYW-5 ctrlH-8], ...
  'BackgroundColor', [1 1 1], ...
  'String', res(1), ...
  'Callback',@set_cal);
...
handles.PbChoose = uicontrol( ...
  ...
  'fontsize', 12, ...
  'Units', 'pixels', ...
  'Position', [ctrlYW+ctrlMW+4 figH-ctrlH+5 ctrlCW-5 ctrlH-8], ...
  'String', 'OK', ...
  'Callback','uiresume');
